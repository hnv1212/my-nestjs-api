...
export class AddProductToCatalogHandler
  implements ICommandHandler<AddProductToCatalogCommand>
{
  public constructor(private readonly catalogStore: CatalogStore) {}

  async execute(command: AddProductToCatalogCommand): Promise<Catalog> {
